...
# Alibabacloud EventBridge SDK for C++

![](https://aliyunsdk-pages.alicdn.com/icons/AlibabaCloud.svg)

The Alibabacloud EventBridge SDK is based on the [`Darabonba DSL`](https://github.com/aliyun/darabonba) solution, which is a domain specific language for OpenAPI applications. It can be used to generate multilingual SDKs, code samples, test cases, interface choreography, etc. for any style of API.
...
3. Build and Install C++ SDK
  * Go to the cmake_build directory and open alibabacloud_event_bridge.sln with Visual Studio Solutions
  * Select  `Release`
...
[Submit Issue](https://github.com/alibabacloud-sdk-cpp/eventbridge/issues/new/choose), Problems that do not meet the guidelines may close immediately.
...
[latest-release]: https://github.com/alibabacloud-sdk-cpp/eventbridge/releases
