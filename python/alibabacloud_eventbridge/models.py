...
class SourceMNSParameters(TeaModel):
    ...
    def validate(self):
        self.validate_required(self.is_base_64decode, 'is_base_64decode')
...
class SourceKafkaParameters(TeaModel):
    ...
    def __init__(
        ...
        offset_rest: str = None,
    ):
        self.instance_id = instance_id
        self.topic = topic
        self.consumer_group = consumer_group
        self.offset_rest = offset_rest
    ...
    def to_map(self):
        ...
        if self.offset_rest is not None:
            result['OffsetRest'] = self.offset_rest
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OffsetRest') is not None:
            self.offset_rest = m.get('OffsetRest')
        return self
...
class EBEventSourceEntry(TeaModel):
    """
    ...
    def validate(self):
        self.validate_required(self.name, 'name')
        self.validate_required(self.new, 'new')
        self.validate_required(self.description, 'description')
        self.validate_required(self.external_source_type, 'external_source_type')
        self.validate_required(self.external_source_config, 'external_source_config')
...
class SaveAndStartEventStreamingRequest(TeaModel):
    ...
    def to_map(self):
        ...
        if self.ebevent_source_entry is not None:
            result['EBEventSourceEntry'] = self.ebevent_source_entry
        if self.filter_pattern is not None:
            result['FilterPattern'] = self.filter_pattern
        result['Targets'] = []
        if self.targets is not None:
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EBEventSourceEntry') is not None:
            self.ebevent_source_entry = m.get('EBEventSourceEntry')
        if m.get('FilterPattern') is not None:
            self.filter_pattern = m.get('FilterPattern')
        self.targets = []
        if m.get('Targets') is not None:
...
class SaveAndStartEventStreamingResponse(TeaModel):
    ...
    def validate(self):
        self.validate_required(self.request_id, 'request_id')
        self.validate_required(self.resource_owner_account_id, 'resource_owner_account_id')
        self.validate_required(self.event_streaming_arn, 'event_streaming_arn')
...
class QueryEventBridgeStatusRequest(TeaModel):
    """
...
class QueryEventBridgeStatusResponse(TeaModel):
    """
    ...
    def __init__(
        ...
        request_id: str = None,
        resource_owner_account_id: str = None,
        default_bus_enable: bool = None,
    ):
        self.request_id = request_id
        self.resource_owner_account_id = resource_owner_account_id
        self.default_bus_enable = default_bus_enable

    def validate(self):
        self.validate_required(self.request_id, 'request_id')
        self.validate_required(self.resource_owner_account_id, 'resource_owner_account_id')
        self.validate_required(self.default_bus_enable, 'default_bus_enable')
    ...
    def to_map(self):
        ...
        if self.resource_owner_account_id is not None:
            result['ResourceOwnerAccountId'] = self.resource_owner_account_id
        if self.default_bus_enable is not None:
            result['DefaultBusEnable'] = self.default_bus_enable
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceOwnerAccountId') is not None:
            self.resource_owner_account_id = m.get('ResourceOwnerAccountId')
        if m.get('DefaultBusEnable') is not None:
            self.default_bus_enable = m.get('DefaultBusEnable')
        return self
