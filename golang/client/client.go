...
type EBAliyunOfficialEventSourceEntry struct {
  ...
  AttachedBuses []*string `json:"AttachedBuses,omitempty" xml:"AttachedBuses,omitempty" require:"true" type:"Repeated"`
...
func (s *EBAliyunOfficialEventSourceEntry) SetAttachedBuses(v []*string) *EBAliyunOfficialEventSourceEntry {
  s.AttachedBuses = v
  return s
}
...
func (s *EBUserDefinedEventSourceEntry) SetExternalSourceType(v string) *EBUserDefinedEventSourceEntry {
  s.ExternalSourceType = &v
  return s
}

func (s *EBUserDefinedEventSourceEntry) SetExternalSourceConfig(v map[string]interface{}) *EBUserDefinedEventSourceEntry {
...
func (s *EBUserDefinedEventSourceEntry) SetAttachedBuses(v []*string) *EBUserDefinedEventSourceEntry {
  s.AttachedBuses = v
  return s
}
...
type ListUserDefinedResponse struct {
  RequestId *string `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
  ResourceOwnerAccountId *string `json:"ResourceOwnerAccountId,omitempty" xml:"ResourceOwnerAccountId,omitempty" require:"true"`
  EventBuses []*EBUserDefinedEventSourceEntry `json:"EventBuses,omitempty" xml:"EventBuses,omitempty" require:"true" type:"Repeated"`
}
...
func (s *ListUserDefinedResponse) SetEventBuses(v []*EBUserDefinedEventSourceEntry) *ListUserDefinedResponse {
  s.EventBuses = v
  return s
}
...
func (client *Client) ListAliyunOfficialEventSourcesWithOptions (request *ListAliyunOfficialRequest, runtime *util.RuntimeOptions) (_result *ListAliyunOfficialResponse, _err error) {
  ...
  _result = &ListAliyunOfficialResponse{}
  _body, _err := client.DoRequest(tea.String("listAliyunOfficialEventSources"), tea.String("HTTP"), tea.String("POST"), tea.String("/openapi/listAliyunOfficialEventSources"), nil, tea.ToMap(request), nil, runtime)
  if _err != nil {
    return _result, _err
  }
  _err = tea.Convert(_body, &_result)
...
func (client *Client) ListUserDefinedEventSourcesWithOptions (request *ListUserDefinedRequest, runtime *util.RuntimeOptions) (_result *ListUserDefinedResponse, _err error) {
  ...
  _result = &ListUserDefinedResponse{}
  _body, _err := client.DoRequest(tea.String("listUserDefinedEventSources"), tea.String("HTTP"), tea.String("POST"), tea.String("/openapi/listUserDefinedEventSources"), nil, tea.ToMap(request), nil, runtime)
  if _err != nil {
    return _result, _err
  }
  _err = tea.Convert(_body, &_result)
