...
namespace AlibabaCloud.SDK.EventBridge
{
    public class EventBridgeClient : IEventBridgeClient
    {
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<ListAliyunOfficialResponse>(DoRequest("listAliyunOfficialEventSources", "HTTP", "POST", "/openapi/listAliyunOfficialEventSources", null, request.ToMap(), null, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<ListAliyunOfficialResponse>(await DoRequestAsync("listAliyunOfficialEventSources", "HTTP", "POST", "/openapi/listAliyunOfficialEventSources", null, request.ToMap(), null, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<ListUserDefinedResponse>(DoRequest("listUserDefinedEventSources", "HTTP", "POST", "/openapi/listUserDefinedEventSources", null, request.ToMap(), null, runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<ListUserDefinedResponse>(await DoRequestAsync("listUserDefinedEventSources", "HTTP", "POST", "/openapi/listUserDefinedEventSources", null, request.ToMap(), null, runtime));
        }
