...
class Eventbridge {
    ...
    public function createEventSourceWithOptions($request, $runtime){
        Utils::validateModel($request);
        return CreateEventSourceResponse::fromMap($this->doRequest("createEventSource", "HTTP", "POST", "/openapi/v2/createEventSource", null, Tea::merge($request), $runtime));
    }
    ...
    public function deleteEventSourceWithOptions($request, $runtime){
        Utils::validateModel($request);
        return DeleteEventSourceResponse::fromMap($this->doRequest("deleteEventSource", "HTTP", "POST", "/openapi/v2/deleteEventSource", null, Tea::merge($request), $runtime));
    }
    ...
    public function updateEventSourceWithOptions($request, $runtime){
        Utils::validateModel($request);
        return UpdateEventSourceResponse::fromMap($this->doRequest("updateEventSource", "HTTP", "POST", "/openapi/v2/updateEventSource", null, Tea::merge($request), $runtime));
    }
    ...
    public function listUserDefinedEventSourcesWithOptions($request, $runtime){
        Utils::validateModel($request);
        return ListUserDefinedResponse::fromMap($this->doRequest("listUserDefinedEventSources", "HTTP", "POST", "/openapi/v2/listUserDefinedEventSources", null, Tea::merge($request), $runtime));
    }
    ...
    public function listAliyunOfficialEventSourcesWithOptions($request, $runtime){
        Utils::validateModel($request);
        return ListAliyunOfficialResponse::fromMap($this->doRequest("listAliyunOfficialEventSources", "HTTP", "POST", "/openapi/v2/listAliyunOfficialEventSources", null, Tea::merge($request), $runtime));
    }
    ...
    public function createEventStreamingWithOptions($request, $runtime){
        Utils::validateModel($request);
        return CreateEventStreamingResponse::fromMap($this->doRequest("createEventStreaming", "HTTP", "POST", "/openapi/v2/createEventStreaming", null, Tea::merge($request), $runtime));
    }
    ...
    public function deleteEventStreamingWithOptions($request, $runtime){
        Utils::validateModel($request);
        return DeleteEventStreamingResponse::fromMap($this->doRequest("deleteEventStreaming", "HTTP", "POST", "/openapi/v2/deleteEventStreaming", null, Tea::merge($request), $runtime));
    }
    ...
    public function getEventStreamingWithOptions($request, $runtime){
        Utils::validateModel($request);
        return GetEventStreamingResponse::fromMap($this->doRequest("getEventStreaming", "HTTP", "POST", "/openapi/v2/getEventStreaming", null, Tea::merge($request), $runtime));
    }
    ...
    public function listEventStreamingMetricsWithOptions($request, $runtime){
        Utils::validateModel($request);
        return ListEventStreamingMetricsResponse::fromMap($this->doRequest("listEventStreamingMetrics", "HTTP", "POST", "/openapi/v2/listEventStreamingMetrics", null, Tea::merge($request), $runtime));
    }
    ...
    public function listEventStreamingsWithOptions($request, $runtime){
        Utils::validateModel($request);
        return ListEventStreamingsResponse::fromMap($this->doRequest("listEventStreamings", "HTTP", "POST", "/openapi/v2/listEventStreamings", null, Tea::merge($request), $runtime));
    }
    ...
    public function pauseEventStreamingWithOptions($request, $runtime){
        Utils::validateModel($request);
        return PauseEventStreamingResponse::fromMap($this->doRequest("startEventStreaming", "HTTP", "POST", "/openapi/v2/pauseEventStreaming", null, Tea::merge($request), $runtime));
    }
    ...
    public function startEventStreamingWithOptions($request, $runtime){
        Utils::validateModel($request);
        return StartEventStreamingResponse::fromMap($this->doRequest("startEventStreaming", "HTTP", "POST", "/openapi/v2/startEventStreaming", null, Tea::merge($request), $runtime));
    }
    ...
    public function updateEventStreamingWithOptions($request, $runtime){
        Utils::validateModel($request);
        return UpdateEventStreamingResponse::fromMap($this->doRequest("updateEventStreaming", "HTTP", "POST", "/openapi/v2/updateEventStreaming", null, Tea::merge($request), $runtime));
    }
}
